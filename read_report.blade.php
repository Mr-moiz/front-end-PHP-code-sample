...
<table>
        ...
        <th  style="text-align: center"> نوع المحصول </th>
            ...
            <th  style="text-align: center">حزف</th>
        </tr>
        </thead>
        <tbody>
       @foreach($data as $d)
        ...
        <td style="text-align: center">{{$d->name}}</td>
            ...
            <td style="text-align: center">{{$d->close_price}}</td>
             <td  style="text-align: center"><a href="{{url('report_edit/'. $d->id)}}">تعديل</a></td>
          <td  style="text-align: center"><a href="{{url('report_delete/'. $d->id)}}">حزف</a></td>
        </tr>
@endforeach
